...
import {
  useGetAdminReviewRatingChart,
  useGetAdminReviewTrendChart
} from "@/lib/actions/reviews/use-admin-reviews";
...
export function ReviewsByRatingChart() {
  const { data, isLoading } = useGetAdminReviewRatingChart();
...
export function RatingTrendChart() {
  const { data, isLoading } = useGetAdminReviewTrendChart();
